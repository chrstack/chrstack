...
export default async function ProjectPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main id="conteudo" className="project-page"><div className="container">
    ...
    <div className="case-grid case-state"><section><span className="case-number">05</span><h2>Estado atual</h2><p>{project.currentState}</p></section><section><span className="case-number">06</span><h2>Próximo passo</h2><p>{project.nextStep}</p></section></div>
    <section className="project-stack"><span className="case-number">07</span><h2>Tecnologias e base</h2><div className="tech-row">{project.technologies.map((tech) => <span key={tech}>{tech}</span>)}</div></section>
  </div></main>;
}
